...
public class VolumePanel extends Handler implements DemoMode {
    ...
    private final class SecondaryIconTransition extends AnimatorListenerAdapter
        ...
        public void run() {
            ...
            */
            mAudioManager.forceVolumeControlStream(StreamResources.RingerStream.streamType);
            mAudioManager.adjustStreamVolume(StreamResources.RingerStream.streamType,
                    AudioManager.ADJUST_SAME, AudioManager.FLAG_SHOW_UI);
            //Modify end for bug-463482
        }
    }
