...
public class LocationTile extends QSTile<QSTile.BooleanState> {
    ...
    private static final String TAG = "LocationTile";
    ...
    protected void handleClick() {
        if (DBG) Log.d("locationTile", "handleClick()");
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        /* SPRD: fixbug421893 show location on top of lock screen on unSecure lock screen.@{
