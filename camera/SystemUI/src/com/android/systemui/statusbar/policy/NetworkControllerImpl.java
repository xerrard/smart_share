...
//        }
        ...
        for (int i = 0; i < phoneCount; i++) {
            ...
            if (controller != null) {
                ...
                SpannableStringBuilder noServiceString = new SpannableStringBuilder(
...
//                }
        ...
        public void notifyListeners() {
            ...
            int fourgIcon = 0;
            if (isRelianceBoard) {
                if (showDataIcon && hasService() && isFourGLTE() && mImsState == 1) {
                    typeIcon = SystemUIPluginsHelper.getInstance().getSignalVoLTEIcon();
                } else if (mPhone.getPhoneType() != TelephonyManager.PHONE_TYPE_NONE
                        && isFourGLTE() && hasService()) {
                    fourgIcon = SystemUIPluginsHelper.getInstance().getFourGIconForVoice();
                }
            }
            /* @} */
            int signalClustersLength = mSignalClusters.size();
...
//                }
    ...
    public interface SignalCluster {
        ...
        // SPRD: modify for bug 434412
        // SPRD: add for reliance case
        void setMobileDataIndicators(boolean visible, int strengthIcon, int typeIcon, int roamIcon, int fourgIcon,
