...
public class RecentsTaskLoader {
    ...
    public String getAndUpdateActivityLabel(Task.TaskKey taskKey,
        ...
        if (infoHandle.info == null) {
            if (taskKey.baseIntent.getComponent() != null
                && taskKey.baseIntent.getComponent().flattenToString()
                .equals("com.android.documentsui/com.android.documentsui.DocumentsActivity")) {
                infoHandle.info = ssp.getActivityInfo(new ComponentName("com.android.providers.downloads.ui",
