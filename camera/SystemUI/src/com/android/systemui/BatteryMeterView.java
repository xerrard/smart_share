...
public class BatteryMeterView extends View implements DemoMode,
    ...
    /* SPRD: fixbug421620 add charge animation of batteryView @{ */
    ...
    /*
     * SPRD:fixbug 468879 When the screen is charged, the operation of the animation is not
     * charged.@{
     */
    ...
    private class BatteryTracker extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                Log.d(TAG, "batteryStatus = "+status);
            ...
            /*
             * SPRD:fixbug 457552 When the screen is charged, the operation of the animation is not
             * charged.@{
             */
                    ...
                    if (mSendTimerTask == null) {
                        mSendTimerTask = new TimerTask() {
                            ...
                            public void run() {
                                ChargeLevel += 20;
                                level = ChargeLevel;
                                Log.d(TAG, "TimerTask :run --level = " + level);
                        ...
                        mSendTimer.schedule(mSendTimerTask, ANIMATION_DURATION, ANIMATION_DURATION);
                    }
                }
            }
            /* @} */
        ...
        private void BatteryMeterViewAnimationShow(Intent intent) {
            ...
            // SPRD: fixbug453412 let the animation shows only if the battery is charging
            if (plugged && level < 100 && status == BatteryManager.BATTERY_STATUS_CHARGING && mScreenOn) {
                if (0 < level && level < 20) {
                    tempLevel = -1;
                ...
                if (mSendTimerTask == null) {
                    mSendTimerTask = new TimerTask() {
                        ...
                        public void run() {
                            ChargeLevel += 20;
                            level = ChargeLevel;
                            Log.d(TAG, "TimerTask :run --level = " + level + ", mScreenOn: " + mScreenOn);
                            mHandler.sendEmptyMessage(LEVEL_UPDATE);
                            if (ChargeLevel > 90) {
                                if (tempLevel > 20) {
                                    ChargeLevel = tempLevel - 20;
    ...
    public void onAttachedToWindow() {
        ...
        /*
         * SPRD:fixbug 457552 When the screen is charged, the operation of the animationis not
         * charged.@{
         */
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mScreenOn = isScreenOn(context);
        Log.d(TAG, "init mScreenOn: " + mScreenOn);
    }
    ...
    public void draw(Canvas c) {
        ...
        // SPRD: fixbug453412 let the bolt icon shows only if the battery is charging
        if (tracker.plugged && level != 100 && tracker.status == BatteryManager.BATTERY_STATUS_CHARGING) {
