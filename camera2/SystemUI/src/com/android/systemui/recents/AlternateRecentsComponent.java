...
public class AlternateRecentsComponent implements ActivityOptions.OnAnimationStartedListener {
    ...
    private boolean mReloadSearchBarAppWidget = false;
    ...
    public void onBootCompleted() {
        Log.d(TAG,"onBootCompleted mReloadSearchBarAppWidget = "+ mReloadSearchBarAppWidget);
        if(mReloadSearchBarAppWidget == true){
            reloadSearchBarAppWidget(mContext, mSystemServicesProxy);
            mReloadSearchBarAppWidget = false;
        }
        mBootCompleted = true;
    }
    ...
    void reloadHeaderBarLayout(boolean reloadWidget) {
        ...
        if (reloadWidget) {
            Log.d(TAG,"reloadHeaderBarLayout mReloadSearchBarAppWidget = "+ mReloadSearchBarAppWidget);
            mReloadSearchBarAppWidget = true;
