...
//        homeIntent.addCategory(Intent.CATEGORY_HOME);
        if(Debug.isMMITest()){
            homeIntent.setClassName("com.sprd.validationtools", "com.sprd.validationtools.ValidationToolsMainActivity");
        }else{
            homeIntent.addCategory(Intent.CATEGORY_HOME);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * SPRD: Bug 447969 - New feature of quick cleaning. @{
         */
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            dismissRecentsToHome(false);//add by wanglei for HQ01713746
        }
    };
    ...
    protected void onStart() {
        ...
        Log.d(TAG, "onStart");
        isClick = false;
        beforeMemory = getAvailMemory(RecentsActivity.this);
        Log.d(TAG, "beforeMemory= " + beforeMemory);
        //add by zhanghui end
        RecentsTaskLoader loader = RecentsTaskLoader.getInstance();
    ...
    protected void onStop() {
        ...
        Log.d(TAG, "onStop");
        // add by zhanghui start
        long afterMemory = getAvailMemory(RecentsActivity.this);
        Log.d(TAG, "afterMemory= " + afterMemory);
        long cleanMemory=0;
        cleanMemory = afterMemory - beforeMemory;
        if (cleanMemory < 0)
            cleanMemory = 0;
        if (FeatureOption.HQ_LAVA_SHOW_CLEAR_MEMORY) {
            if (isClick) {
                Toast.makeText(this, cleanMemory+getString(R.string.show_clear_memory_text), Toast.LENGTH_SHORT).show();
            }
        }
        //add by zhanghui end
        RecentsTaskLoader loader = RecentsTaskLoader.getInstance();
