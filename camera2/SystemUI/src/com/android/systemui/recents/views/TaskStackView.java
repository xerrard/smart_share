...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
    ...
    // SPRD: fixbug428896 Add Log Tag and try-catch exception
        ...
        if (0 <= taskIndex && taskIndex < mStack.getTaskCount()) {
            ...
            if (tv != null) {
                ...
                postScrollRunnable = new Runnable() {
                    @Override
                    public void run() {
                        // SPRD: fixbug442505 Adding judgment, in the case of the error, directly assigned to the initial value
    ...
    public void startLaunchTaskAnimation(TaskView tv, Runnable r, boolean lockToTask) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (t == tv) {
                ...
                /*SPRD: fixbug 435017 NPE:isTaskAboveTask()' on a null object reference.@{*/
