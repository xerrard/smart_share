    ...
    private void startAssistActivity() {
        ...
        try {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    //modify by yujinwang
                    if (com.huaqin.common.featureoption.FeatureOption.HQ_SPRD_SLIDEUP_HOME_TO_GOOGLE_SEARCH){
                        Intent googleSearchIntent = new Intent(Intent.ACTION_ASSIST);
                        googleSearchIntent.setComponent(new ComponentName
                        ("com.google.android.googlequicksearchbox","com.google.android.googlequicksearchbox.SearchActivity"));
			            if (null != intent && null != intent.getExtras()){
			                googleSearchIntent.putExtras(intent.getExtras());
			            }
			            mContext.startActivityAsUser(googleSearchIntent, opts.toBundle(),new UserHandle(UserHandle.USER_CURRENT));
			        } else {
    ...
    private void maybeSwapSearchIcon() {
        ...
        if (intent != null) {
            ...
            if(com.huaqin.common.featureoption.FeatureOption.HQ_SPRD_SLIDEUP_HOME_TO_GOOGLE_SEARCH){
                ...
                component = new ComponentName("com.google.android.googlequicksearchbox", 
