...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    protected void handleClick() {
        ...
        // add by jiangguohu 2016.01.14 start
        if(getSosStatus()){
            Log.d(TAG,"---------getSosStatus: "+getSosStatus());
            Intent intent = new Intent();
            intent.setAction("com.android.service.flashlightsos.action.stop");
            mHost.getContext().sendBroadcast(intent);
            return;
        }
        // add by jiangguohu 2016.01.14 end
    ...
    private boolean getSosStatus() {
        boolean serviceRunning = false;
        String serviceName = "com.hq.flashlight.SosService";
        ActivityManager am = (ActivityManager) mHost.getContext().getSystemService(Context.ACTIVITY_SERVICE);
