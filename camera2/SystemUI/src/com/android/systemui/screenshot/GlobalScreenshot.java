...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    private static final int SUPPORT_GLOBAL_STORAGE_LOCATION = 0;
    private static final int SUPPORT_AUTO_STORAGE_LOCATION = 1;
    private static final int SUPPORT_DEFAULT_STORAGE_LOCATION = 2;
    private static int mStorageLocationType = SUPPORT_GLOBAL_STORAGE_LOCATION;
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        mScreenshotDir = new File(getStorePath(context), SCREENSHOTS_DIR_NAME);
        /*SPRD :fix bug 440402,modify save path for a screenshot@} */
    ...
    protected SaveImageInBackgroundData doInBackground(SaveImageInBackgroundData... params) {
        ...
        try {
            ...
            /*SPRD :fixbug446590 Set the connection USB, MTP mode, the computer can view screenshots, screenshots.@{*/
            FileOutputStream out = new FileOutputStream(new File(mImageFilePath));
	...
	File pathDir = null;
	Log.d(TAG, "getStorePath---mStorageLocationType:"+mStorageLocationType);
	switch (mStorageLocationType) {
	case SUPPORT_GLOBAL_STORAGE_LOCATION:
	    int selectedLocation = Settings.Global.getInt(context.getContentResolver(),
	        Settings.Global.DEFAULT_STORAGE_LOCATION, STORAGE_DEVICE);
	    Log.i(TAG, "getStorageLocation selectedLocation:"+ selectedLocation);
	    if (selectedLocation == STORAGE_SDCARD&& Environment.MEDIA_MOUNTED.equals(Environment.getExternalStoragePathState())) {
	        pathDir = Environment.getExternalStoragePath();
	    } else {
	        pathDir = Environment.getInternalStoragePath();
	    }
	    break;
	case SUPPORT_AUTO_STORAGE_LOCATION:
	    ...
	    break;
	case SUPPORT_DEFAULT_STORAGE_LOCATION:
	    pathDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
	    Log.d(TAG, "getStorePath--SUPPORT_DEFAULT_STORAGE_LOCATION--pathDir:"+pathDir);
	    return pathDir;
	default:
	    break;
	}
	Log.d(TAG, "getStorePath---pathDir:"+pathDir);
