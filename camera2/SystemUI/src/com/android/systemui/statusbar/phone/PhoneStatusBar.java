...
import com.android.systemui.statusbar.policy.AirShutterControllerImpl;//hss airshutter
import com.sprd.systemui.statusbar.policy.GestureControllerImpl;//wangsheng
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    // SPRD: bug459470, support transition on low-ram device. 
	...
	AirShutterControllerImpl mAirShutterController;//hss airshutter
    GestureControllerImpl mGestureController;//wangsheng
    ...
    protected PhoneStatusBarView makeStatusBarView() {
	    ...
	    mAirShutterController=new AirShutterControllerImpl(mContext);
	    mGestureController=new GestureControllerImpl(mContext,this);//add by wangsheng
        ...
        if (mQSPanel != null) {
            final QSTileHost qsh = new QSTileHost(mContext, this,
                    ...
                    mNetworkController, mZenModeController, mHotspotController,mGestureController,
                    mCastController, mFlashlightController,
                    mUserSwitcherController, mKeyguardMonitor,
                    mAirShutterController,
                    mSecurityController);
    ...
    private void prepareNavigationBarView() {
        ...
        //modify by yujinwang start
        if (!com.huaqin.common.featureoption.FeatureOption.HQ_SPRD_ZSL1805_OPLUS_LONGPRESS_HOME_TO_RECENT) {
            mNavigationBarView.getHomeButton().setOnTouchListener(mHomeActionListener);
        }
        //modify by yujinwang end
        updateSearchPanel();
    }
    ...
    private void addHeadsUpView() {
        ...
        // SPRD: fixbug422243 Change the location of the headsUp
        SystemuiFeatureUtil.getInstace().changeHeadsUpbelowStatusBar(lp,this);
...
//            && mState != StatusBarState.KEYGUARD;
    ...
    public void disable(int state, boolean animate) {
        ...
        // Added to Debug DISABLE_EXPAND.
        if((diff  & StatusBarManager.DISABLE_EXPAND) != 0){
            Log.e("StatusBarDisableMonitor", "PhoneStatusBar is set to " + (((state & StatusBarManager.DISABLE_EXPAND) != 0) ? "DISABLE_EXPAND" : "ENABLE_EXPAND") + " !");
            Log.e("StatusBarDisableMonitor", Log.getStackTraceString(new Throwable()));
        }
    ...
    boolean panelsEnabled() {
        boolean statusBarDisabled = (mDisabled & StatusBarManager.DISABLE_EXPAND) == 0;
        Log.d(TAG,"panelsEnabled statusBarDisabled = " + statusBarDisabled);
...
//            Log.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
    ...
    public void onCameraHintStarted() {
        /* SPRD: fixbug422243 Change the hint when click the Profile icon @{ */
        if (!SystemuiFeatureUtil.getInstace().changeProfileHint(mKeyguardIndicationController)) {
    ...
    protected void toggleRecents() {
        ...
        /* SPRD: add for bug 446207,awake the dreams after toggling the recents. @{ */
        awakenDreams();
        /* @} */
        mSystemUiVisibility ^= View.RECENT_APPS_VISIBLE;
        notifyUiVisibilityChanged(mSystemUiVisibility);
