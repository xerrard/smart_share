...
public class NotificationPanelView extends PanelView implements
    ...
    //SPRD: fixbug425773 make the notificationpanle close when click userSwitch
    private MultiUserSwitch mUserSwitch;
    ...
    protected void onFinishInflate() {
        ...
        //SPRD: fixbug425773 make the notificationpanle close when click userSwitch
        mUserSwitch = (MultiUserSwitch)mHeader.findViewById(R.id.multi_user_switch);
        ...
        // SPRD: fixbug377018 Add EmergencyButton on the Lockscreen
    ...
    private void updateHeaderKeyguard() {
        ...
        /* SPRD:fix bug 426275,Click more setting in WLAN is the emergency call in lock screen. @{*/
        float alpha = Math.min(1 - getQsExpansionFraction(), alphaNotifications);
        mKeyguardBottomArea.setAlpha(alpha);
        if(mEmergencyButton != null){
            if (alpha < 0.1) {
                mEmergencyButton.setVisibility(View.INVISIBLE);
            } else {
                if (!CuccSupport.getInstance().makeEmergencyInvisible()) {
    ...
    public void onAnimationToSideStarted(boolean rightPage, float translation, float vel) {
        ...
        if (start) {
            ...
            /* SPRD: fixbug422243 use addon to support the function of changing RINGER_MODE @{ */
