...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mlp.bottomMargin != indicationBottomMargin) {
            // SPRD : fixbug377018 Add EmergencyButton on the Lockscreen and porting the Emeegencybutton
    ...
    public void launchCamera() {
        //SPRD : bugfix468024 Open flashlight, can not enter from the lock screen camera.
    ...
    private void inflatePreviews() {
        ...
        /*SPRD : fixbug 440399 CMCC version to delete the camera Icon.*/
    ...
    protected void onAttachedToWindow() {
        SystemuiFeatureUtil.getInstace().changeCameraToProfile(mCameraImageView);
        super.onAttachedToWindow();
    }
    public boolean launchAudioProfile() {
        return SystemuiFeatureUtil.getInstace().launchAudioProfile(mActivityStarter,mContext);
    }
