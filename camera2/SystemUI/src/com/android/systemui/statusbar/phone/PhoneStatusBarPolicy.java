...
public class PhoneStatusBarPolicy {
    ...
    private static final String SLOT_OUTDOOR = "outdoor";//add by wangshenxing for MODE_OUTDOOR 2015.12.16
    ...
    public PhoneStatusBarPolicy(Context context, CastController cast, HotspotController hotspot) {
        ...
        // SPRD: add to support ims reg
        if("cmcc".equals(SystemProperties.get("ro.operator"))){
            mService.setIcon("imsreg", R.drawable.stat_sys_volte_cmcc, 0, null);
        }else{
            mService.setIcon("imsreg", R.drawable.stat_sys_volte, 0, null);
        }
        mService.setIconVisibility("imsreg", false);
    }
    ...
    private final void updateVolumeZen() {
        ...
        //add by wangshenxing for MODE_OUTDOOR start 2015.12.16
        if (mZen != Global.ZEN_MODE_NO_INTERRUPTIONS &&
                audioManager.getRingerMode() == AudioManager.RINGER_MODE_OUTDOOR) {
            volumeVisible = true;
            volumeIconId = R.drawable.stat_sys_zen_outdoor;
            volumeDescription = mContext.getString(R.string.accessibility_ringer_vibrate);
        }
        //add by wangshenxing for MODE_OUTDOOR end 2015.12.16
