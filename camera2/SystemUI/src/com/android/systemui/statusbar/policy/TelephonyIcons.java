...
class TelephonyIcons {
    ...
    //GSM/UMTS
    static final int TELEPHONY_NO_NETWORK = SystemUIPluginsHelper.getInstance().getNoServiceIconId();
    ...
    static final int ICON_4GLTE = SystemUIPluginsHelper.getInstance().getFourGLte();
    ...
    static final MobileIconGroup THREE_G = new MobileIconGroup(
            ...
            TelephonyIcons.ICON_H,//zhangduanhua , HQ00121315,20160216
            true,
