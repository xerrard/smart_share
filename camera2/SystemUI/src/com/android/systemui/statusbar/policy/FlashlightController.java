...
import android.os.FlashLightManager;
...
public class FlashlightController {
    ...
    public void initialize() {
        ...
        mFlashLightManager = FlashLightManager.getInstance();
    }
	...
	private void registerListenerBroadcast() {	

		IntentFilter filter = new IntentFilter();	
		filter.addAction(Intent.ACTION_FLASHLIGHT_STATE_CHANGED);	
		mContext.registerReceiver(mReceiver, filter);	
	}	
	private void unresisterListenerBroadcast() {	
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {	
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(Intent.ACTION_FLASHLIGHT_STATE_CHANGED)) {	
			    synchronized (this) {	
			    mFlashlightEnabled = false;	
			}	
			dispatchOff();	
