...
public class AccessPointControllerImpl implements NetworkController.AccessPointController {
    ...
    private int getConnectedNetworkId(WifiInfo wifiInfo) {
        return (wifiInfo != null && SupplicantState.COMPLETED == wifiInfo.getSupplicantState()) ? wifiInfo.getNetworkId() : AccessPoint.NO_NETWORK;
    }
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void setListening(boolean listening) {
            if (listening && !mRegistered) {
                ...
                /* SPRD: Do not register broadcasts what are not handled.
