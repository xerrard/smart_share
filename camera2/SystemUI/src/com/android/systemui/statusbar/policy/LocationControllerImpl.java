...
public class LocationControllerImpl extends BroadcastReceiver implements LocationController {
    ...
    public LocationControllerImpl(Context context) {
        ...
        context.registerReceiverAsUser(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (DBG) Log.d(TAG, "LocationControllerImpl onReceive, action =" + action);
    ...
    public boolean setLocationEnabled(boolean enabled) {
        ...
        if (DBG) Log.d(TAG, "setLocationEnabled, isUserLocationRestricted(currentUserId) =" + isUserLocationRestricted(currentUserId) + ", enabled =" + enabled);
    ...
    private void refreshViews() {
        if (DBG) Log.d(TAG, "refreshViews(), mAreActiveLocationRequests = " + mAreActiveLocationRequests);
