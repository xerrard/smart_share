...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    protected NotificationData.Entry createNotificationViews(StatusBarNotification sbn) {
        ...
        //SPRD: check if icon valide @{
        if (n.icon == 0) {
            Log.e(TAG, "createNotificationViews failed as invalide icon! n = " + n);
            return null;
        }
        // @}
        ...
        final StatusBarIcon ic = new StatusBarIcon(sbn.getPackageName(),
                sbn.getUser(),
                    ...
                    n.tickerText);
        if (!iconView.set(ic)) {
            handleNotificationError(sbn, "Couldn't create icon: " + ic + ", n = " + n);
            return null;
        }
    ...
    protected boolean shouldInterrupt(StatusBarNotification sbn) {
        ...
        try {
            if(mDreamManager != null) { //taojinjing 20151215 HQ01567729 add 
                interrupt = interrupt && !mDreamManager.isDreaming();
            } //taojinjing 20151215 HQ01567729 add 
        } catch (RemoteException e) {
