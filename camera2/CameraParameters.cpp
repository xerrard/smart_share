...
//Values for capture_mode settings.
const char CameraParameters::KEY_CAPTURE_MODE[] = "capture-mode";

//Values for flash_mode_support settings.
const char CameraParameters::KEY_FLASH_MODE_SUPPORTED[] = "flash-mode-supported";

//Values for performance-autotest settings
const char CameraParameters::KEY_PERFORMANCE_AUTOTEST[] = "performance-autotest";

//Values for perfect skin
...
int CameraParameters::getSprdCaptureMode() const
{
    return getInt(KEY_CAPTURE_MODE);
}
